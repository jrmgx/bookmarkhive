 ...
 */
// TODO in some extends we want to mutualise this and UserMeBookmarkProvider (filter and pagination)
final readonly class UserProfileBookmarkProvider implements ProviderInterface
{
    ...
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): array|Bookmark|null
    {
        ...
        if ($operation instanceof CollectionOperationInterface) {
            ...
            if ($isOwner) {
                return $this->bookmarkRepository->applyFilters(
            ...
            // TODO handle pagination
            $bookmarks = $this->bookmarkRepository->applyFilters(
