...
#[AsTask(name: 'install', description: 'Installs the api (composer, yarn, ...)')]
...
#[AsTask(description: 'Migrates database schema', namespace: 'db', aliases: ['migrate'])]
...
#[AsTask(description: 'Loads fixtures', namespace: 'db', aliases: ['fixtures'])]
